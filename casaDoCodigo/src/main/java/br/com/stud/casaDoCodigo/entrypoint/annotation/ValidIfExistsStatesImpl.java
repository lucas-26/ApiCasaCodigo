...
public class ValidIfExistsStatesImpl implements ConstraintValidator<ValidIfExistsStates, String> {
    ...
    public ValidIfExistsStatesImpl(EntityManager manager) {
        this.manager = manager;
    }

    @Override
    public void initialize(ValidIfExistsStates constraintAnnotation) {
